              ...
              <div class="card-body">
                <div class="card text-center">
                  <div class="card-body">
                    ...
                    <p class="card-text">Terima kasih telah melakukan pendaftaran di SMK RIDWAN ARIOMAN 202043579075. Pengumuman pada tanggal: </p>
                    <span class="badge badge-danger" style="font-size: 20px;">5 Oktober 2019</span>
                  </div>
                  <div class="card-footer text-muted">
                    <marquee style="margin-bottom: -5px;">SMK RIDWAN ARIOMAN 202043579075</marquee>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="card-body">
                <div class="card text-center">
                  <div class="card-body">
                    ...
                    <p class="card-text">Selamat anda lolos seleksi di SMK RIDWAN ARIOMAN 202043579075. Lakukan Daftar Ulang pada tanggal: </p>
